...
<div className='table-arrenge'> 
  <table >
    ...
    <ShowCardInTable value='شماره پرونده:' onChange={(e)=>setPersonalNO(e.target.value)}/>
    <ShowCardInTable value='نوع کمک:' onChange={(e)=>setAgreement(e.target.value)}/>
    <ShowCardInTable value='مبلغ:' onChange={(e)=>setDepartment(e.target.value)}/>    
    <ShowCardInTable value='مدت ماه:' onChange={(e)=>setDepartment(e.target.value)}/>    
    </tbody>
  </table> 
  <table  >
    <tbody>
    <ShowCardInTable value='شرح  :' onChange={(e)=>setPrice(e.target.value)}/>
